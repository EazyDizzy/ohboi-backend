...
use lib::db::product_characteristic::repository::{get_mapped_float_values, get_mapped_string_values, get_mapped_enum_values, get_product_characteristics};
use bigdecimal::ToPrimitive;
use lib::db::product_characteristic::characteristic_id::get_characteristic_by_id;
