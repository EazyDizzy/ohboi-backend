...
use crate::daemon::queue::consumer::parse_details::ParseDetailsMessage;
use crate::daemon::queue::consumer::parse_image::UploadImageMessage;
use crate::daemon::queue::consumer::parse_page::ParsePageMessage;
