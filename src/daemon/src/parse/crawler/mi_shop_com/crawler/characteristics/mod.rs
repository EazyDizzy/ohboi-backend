...
use crate::parse::crawler::mi_shop_com::crawler::characteristics::enums::extract_enum_characteristic;
use crate::parse::crawler::mi_shop_com::crawler::characteristics::float::extract_float_characteristic;
