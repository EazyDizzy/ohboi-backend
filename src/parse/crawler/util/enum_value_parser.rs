...
pub fn enum_internet_connection_technology_value(
    value: &str,
...
pub fn enum_satellite_navigation_value(value: &str) -> Option<SatelliteNavigation> {
    match string_value(value).as_str() {
...
pub fn enum_wifi_standard_value(value: &str) -> Option<WifiStandard> {
    match string_value(value).as_str() {
...
pub fn enum_material_value(value: &str) -> Option<Material> {
    match string_value(value).as_str() {
...
pub fn enum_sim_card_value(value: &str) -> Option<SimCard> {
    match string_value(value).as_str() {
...
pub fn enum_charging_connector_type_value(value: &str) -> Option<ChargingConnectorType> {
    match string_value(value).as_str() {
...
pub fn enum_country_value(value: &str) -> Option<Country> {
    match string_value(value).as_str() {
        "Китай" => Some(Country::China),
        _ => None,
    }
}
pub fn enum_memory_card_slot_value(value: &str) -> Option<MemoryCardSlot> {
    match string_value(value).as_str() {
...
pub fn enum_audio_jack_value(value: &str) -> Option<AudioJack> {
    match string_value(value).as_str() {
...
pub fn enum_battery_type_value(value: &str) -> Option<BatteryType> {
    match string_value(value).as_str() {
...
pub fn enum_display_type_value(value: &str) -> Option<DisplayType> {
    match string_value(value).as_str() {
